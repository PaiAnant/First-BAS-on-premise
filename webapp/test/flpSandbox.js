		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "First BAS On-Premise app",
									"targetURL": "#comfirstbasfirstbas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comfirstbasfirstbas-display": {
								"semanticObject": "comfirstbasfirstbas",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.firstbas.firstbas",
									"url": sap.ui.require.toUrl("com/firstbas/firstbas")
								}
							}
						}
					}
